...
describe('OffenseDefenseDamageData', function(){
    beforeEach(function(){
        this.addMatchers({
            toEqualRecord: function(body, weapons, protectors, expression, mob){
    ...
    it('records は設定した offense, defense の組み合わせとなる', function(){
        ...
        expect(records[0]).toEqualRecord(body, weapons, protectors, expression, mob);
        expect(records[1]).toEqualRecord(body, weapons, protectors, expression, mob2);
        expect(records[2]).toEqualRecord(body2, weapons2, protectors2, expression2, mob);
        expect(records[3]).toEqualRecord(body2, weapons2, protectors2, expression2, mob2);
    });
